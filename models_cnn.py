...
class VoiceDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        label = torch.tensor(self.y[idx], dtype=torch.long) # per torch: synonymous to int64
        return sample, label
...
class AudioCNN(nn.Module):
    ...
    def fit(self, train_loader, val_loader, criterion, optimizer, device, n_epochs=100, patience=15, save_path='model.pt'):
...
class BaseCNN(AudioCNN):
    def __init__(self, num_classes=10):
        ...
        self.conv2 = nn.Conv2d(16, 32, kernel_size=(3, 5), stride=(1, 1), padding=(1, 1))
...
class CNNLSTMNet(AudioCNN):
    def __init__(self, num_filters_conv1, num_filters_conv2, num_filters_conv3, num_filters_conv4, hidden_size_lstm, dropout_rate, num_classes=10):
        super(CNNLSTMNet, self).__init__()

        self.hidden_size_lstm = hidden_size_lstm

        self.conv1 = nn.Conv2d(1, num_filters_conv1, kernel_size=(5,5), stride=(1,1), padding=(2,2))
        self.relu1 = nn.ReLU()
        self.pool1 = nn.MaxPool2d(kernel_size=(2,2), stride=(2,2))
        self.dropout1 = nn.Dropout(dropout_rate)

        self.conv2 = nn.Conv2d(num_filters_conv1, num_filters_conv2, kernel_size=(5,5), stride=(1,1), padding=(2,2))
        self.relu2 = nn.ReLU()
        self.pool2 = nn.MaxPool2d(kernel_size=(2,2), stride=(2,2))
        self.dropout2 = nn.Dropout(dropout_rate)

        self.conv3 = nn.Conv2d(num_filters_conv2, num_filters_conv3, kernel_size=(5,5), stride=(1,1), padding=(2,2))
        self.relu3 = nn.ReLU()
        self.pool3 = nn.MaxPool2d(kernel_size=(2,2), stride=(2,2))
        self.dropout3 = nn.Dropout(dropout_rate)

        self.conv4 = nn.Conv2d(num_filters_conv3, num_filters_conv4, kernel_size=(5,5), stride=(1,1), padding=(2,2))
        self.relu4 = nn.ReLU()
